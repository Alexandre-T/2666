...
function page_header($page_title = '', $display_online_list = true, $item_id = 0, $item = 'forum', $meta = null)
{
	...
	$template->assign_vars(array(
	    ...
	    'U_MEMBERLIST_ASMODEENS'=> append_sid($phpbb_root_path.'../clan/asmodeens.html'),
	    'U_MEMBERLIST_INFILTRES'    => append_sid($phpbb_root_path.'../clan/infiltres.html'),
	    'U_MEMBERLIST_INSOUMIS'		=> append_sid($phpbb_root_path.'../clan/insoumis.html'),
	    'U_MEMBERLIST_IZANAGHIS'	=> append_sid($phpbb_root_path.'../clan/izanaghis.html'),
	    'U_MEMBERLIST_SANS_CLAN'	=> append_sid($phpbb_root_path.'../clan/sans-clan.html'),
	    'U_MEMBERLIST_SKJALDMEYJAR'	=> append_sid($phpbb_root_path.'../clan/skjaldmeyjar.html'),
	    'U_MEMBERLIST_VESTALES'	=> append_sid($phpbb_root_path.'../clan/vestales.html'),
	    'U_HOME'                => "/",
